...
interface TypewriterProps {
    ...
    deleteSpeed?: number;
    loop?: boolean;
    /** delay in ms after last word before looping back to first. defaults to waitTime */
    loopDelay?: number;
    className?: string;
    showCursor?: boolean;
    ...
    useEffect(() => {
        ...
        const startTyping = () => {
            if (isDeleting) {
                ...
                // loopDelay for last word, otherwise waitTime
                const isLastWord = currentTextIndex === texts.length - 1;
                const delay = isLastWord && loopDelay !== undefined ? loopDelay : waitTime;
                timeout = setTimeout(() => {
                    setIsDeleting(true);
                }, delay);
            }
