...
export function StaticNoise({
    ...
    return (
        <div
            className={cn(
                "pointer-events-none select-none invert dark:invert-0",
                className,
            )}
            style={{
